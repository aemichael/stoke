...
class LeakageValidatorBaseTest : public ::testing::TestWithParam<std::tr1::tuple<ObligationChecker::AliasStrategy, Solver>> {

public:

  LeakageValidatorBaseTest() {
...
TEST_P(LeakageValidatorBaseTest, NoLoopsPasses) {
...
TEST_P(LeakageValidatorBaseTest, NoLoopsFails) {
...
TEST_P(LeakageValidatorBaseTest, UnsupportedInstruction) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetEqual) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetUnequal) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetLoopEqual) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetLoopUnqual) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetCorrectValue) {
...
TEST_P(LeakageValidatorBaseTest, RipWritingEquiv) {
...
TEST_P(LeakageValidatorBaseTest, RipOffsetWrongValue) {
...
TEST_P(LeakageValidatorBaseTest, PopcntEqual) {
...
TEST_P(LeakageValidatorBaseTest, PopcntWrong) {
...
TEST_P(LeakageValidatorBaseTest, PopcntWrongBeyondBound) {
...
TEST_P(LeakageValidatorBaseTest, EasyMemory) {
...
TEST_P(LeakageValidatorBaseTest, EasyMemoryFail) {
...
TEST_P(LeakageValidatorBaseTest, CanTurnOffMemoryChecking) {
...
TEST_P(LeakageValidatorBaseTest, NoHeapOutStackOutStillSensitiveToReads) {
...
TEST_P(LeakageValidatorBaseTest, WriteDifferentPointers) {
...
TEST_P(LeakageValidatorBaseTest, MemoryOverlapEquiv) {
...
TEST_P(LeakageValidatorBaseTest, MemoryOverlapEquiv2) {
...
TEST_P(LeakageValidatorBaseTest, MemoryOverlapBad) {
...
TEST_P(LeakageValidatorBaseTest, LoopMemoryEquiv) {
...
TEST_P(LeakageValidatorBaseTest, LoopMemoryWrong) {
...
TEST_P(LeakageValidatorBaseTest, LoopMemoryWrong2) {
...
TEST_P(LeakageValidatorBaseTest, Wcslen2ExitsPass) {
...
TEST_P(LeakageValidatorBaseTest, Wcslen2ExitsFail1) {
...
TEST_P(LeakageValidatorBaseTest, LoopMemoryWrong3) {
...
TEST_P(LeakageValidatorBaseTest, MemcpyCorrect) {
...
TEST_P(LeakageValidatorBaseTest, MemcpyVectorizedWrongWithAliasing) {
...
TEST_P(LeakageValidatorBaseTest, MemcpyVectorizedCorrectWithoutAliasing) {
  ...
  validator->set_alias_strategy(LeakageValidator::AliasStrategy::STRING_NO_ALIAS);
  EXPECT_TRUE(validator->verify(target, rewrite));
  EXPECT_FALSE(validator->has_error()) << validator->error();

}

TEST_P(LeakageValidatorBaseTest, MemcpyMissingBranch) {
...
TEST_P(LeakageValidatorBaseTest, MemoryCounterexample) {
...
TEST_P(LeakageValidatorBaseTest, StrlenCorrect) {
...
TEST_P(LeakageValidatorBaseTest, StrlenWrongBranch) {
...
TEST_P(LeakageValidatorBaseTest, WcslenCorrect) {
...
TEST_P(LeakageValidatorBaseTest, DISABLED_WcslenCorrect2) {
...
TEST_P(LeakageValidatorBaseTest, WcslenWrong1) {
...
TEST_P(LeakageValidatorBaseTest, WcslenWrong2) {
...
TEST_P(LeakageValidatorBaseTest, WcslenCorrect3) {
...
TEST_P(LeakageValidatorBaseTest, WcslenWrong3) {
...
TEST_P(LeakageValidatorBaseTest, WcslenWrong4) {
...
TEST_P(LeakageValidatorBaseTest, WcslenWrong5) {
...
TEST_P(LeakageValidatorBaseTest, WcscpyWrong1) {
...
TEST_P(LeakageValidatorBaseTest, NoSpuriousCeg) {
...
INSTANTIATE_TEST_CASE_P(AllSolversAliasing, LeakageValidatorBaseTest,
                        ::testing::Combine(
