...
class LeakageValidator : public ObligationChecker {

public:

  LeakageValidator(SMTSolver& solver) : ObligationChecker(solver), target_final_state_(), rewrite_final_state_() {
    set_bound(2);
  ...
  /** Set bound. */
  LeakageValidator& set_bound(size_t n) {
    bound_ = n;
    return *this;
  }
  ...
  LeakageValidator& set_no_bailout(bool b) {
    bailout_ = !b;
    return *this;
  }
